...
import { IconPerson, IconCross, IconComment, IconFriendDelete, IconActivity } from '@/components/icons'
import { usersApi } from '@/api/users'
import { friendsApi, type FriendRequestItem } from '@/api/friends'
